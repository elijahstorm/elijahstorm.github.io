...
function introduce() {
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        doungdoungei.speech =
          'This place will be a fun story about the importance of Bees in our ecosystem.'
        setTimeout(() => {
          doungdoungei.speech = null
          setTimeout(() => {
            kimchi.speech =
              'Yeah! All this space will be replaced with a natural forest.'
            setTimeout(() => {
              kimchi.speech = null
              setTimeout(() => {
                kimchi.speech =
                  "Why are you still here? I promise there's nothing interesting to wait for."
                setTimeout(() => {
                  kimchi.speech = null
                  setTimeout(() => {
                    ...
                    setTimeout(() => {
                      ...
                      setTimeout(() => {
                        eunbyeul.speech =
                          "Alright, you have to go. We're sending you back..."
                        setTimeout(() => {
                          window.location = '..'
                        }, 5000)
                      }, 15000)
...
function apologize() {
  setTimeout(() => {
    document.getElementById('adventure-container').style.transition =
      'opacity .5s ease'
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        doungdoungei.speech =
          "I am actively working on this, and it'll be cool soon :) - Elijah 12/01/2021"
        document.getElementById('adventure-container').style.opacity = '.4'
        setTimeout(() => {
          doungdoungei.speech = null
          document.getElementById('adventure-container').style.opacity = '1'
          setTimeout(() => {
            kimchi.speech =
              'Thank you for checking out my project development! I would love if you left me a message, you can do that by hitting the back button!'
            document.getElementById('adventure-container').style.opacity = '.4'
            setTimeout(() => {
              kimchi.speech = null
              document.getElementById('adventure-container').style.opacity = '1'
              document
                .querySelector('#exit-nav-back-button>*>div')
...
setTimeout(() => {
  ...
  setTimeout(() => {
    document
      .querySelector('#exit-nav-back-button .ease')
