...
class CharacterClass {
  ...
  get position() {
    return Ai.createVector(this.#_x + this.size / 2, this.#_y + this.size / 2)
  }
  set position(v) {
    this.move(v.x, v.y)
  }
  ...
  flee = (enemies) => {
    this.travel_by_angle(this.find_flee_angle(enemies), this.travel_distance)
  }
  random_move = () => {
...
class ActorClass extends CharacterClass {
  ...
  act = () => {
    this.scale(Math.min(1, this.#_life-- / MAX_HEALTH + 0.3))
  }
...
class NormalBeeActor extends ActorClass {
  ...
  death_action = () => {
    this.all_bees.splice(this.all_bees.indexOf(this), 1)
  }
...
class EnemyWaspActor extends ActorClass {
  ...
  death_action = () => {
    this.all_enemies.splice(this.all_enemies.indexOf(this), 1)
  }
...
class GhostActor extends ActorClass {
  ...
  act = () => {
    ...
    this.move(CharacterClass.middle_x(), CharacterClass.random_y())
